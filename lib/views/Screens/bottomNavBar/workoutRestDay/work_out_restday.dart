...
//
// class WorkOutRestDayScreen extends StatelessWidget {
...
class _WorkOutRestDayScreenState extends State<WorkOutRestDayScreen>
        ...
        return AlertDialog(
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                _buildRoutineButton(Icons.edit, 'Edit Routine', context),
                _buildRoutineButton(Icons.refresh, 'New Routine', context),
                _buildRoutineButton(Icons.delete, 'Delete Routine', context),
              ],
            ),
          ),
        );
  ...
  Widget _buildRoutineButton(IconData icon, String text, BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        border: Border(
